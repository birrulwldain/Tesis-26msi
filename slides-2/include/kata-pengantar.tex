...
\begin{enumerate}
    ...
    \item Bapak \@firstsupervisor \textit{ }selaku  Pembimbing I yang telah banyak memberikan bimbingan dan arahan kepada penulis, sehingga penulis dapat menyelesaikan Tugas Akhir ini.
    ...
    \item Ibu Dr. Gunawati, S.Si., M.Si. dan Bapak T. Khairuman, S.Si., M.Si. selaku Tim Penguji yang telah memberikan masukan dan saran kepada penulis dalam penyelesaian Tugas Akhir/Tesis ini.
    \item Ibu Dr. Rara Mitaphonna, S.Si. selaku Kolaborator dari Pusat Riset Fotonika BRIN yang telah memberikan bantuan dalam penyelesaian Tugas Akhir ini.
    \item Pusat Riset Komputasi, Organisasi Riset Elektronika dan Informatika, Badan Riset dan Inovasi Nasional (BRIN) yang telah memberi izin akses terhadap infrastruktur \textit{High Performance Computing} (HPC) Mahameru 4 sangat penting dalam memungkinkan pelaksanaan penelitian ini.
    ...
    \item Seluruh teman-teman mahasiswa Program Studi Sarjana Fisika Fakultas MIPA 2020 yang senantiasa menyemangati dan menemani penulis untuk menyelesaikan Tugas Akhir ini.
\end{enumerate}
%\vspace{1.5cm}
