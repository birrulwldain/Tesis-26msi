...
\newcommand{\lampiran}[1]{%
  ...
  \renewcommand{\thesection}{\thelampiran.\arabic{section}}%
  \renewcommand{\thesubsection}{\thesection.\arabic{subsection}}%
  \renewcommand{\thefigure}{\thelampiran.\arabic{figure}}%
  \renewcommand{\thetable}{\thelampiran.\arabic{table}}%
  \renewcommand{\thealgorithm}{\thelampiran.\arabic{algorithm}}%
  \renewcommand{\theequation}{\thelampiran.\arabic{equation}}%
  
  \phantomsection
  \subsection*{Lampiran \thelampiran. #1}%
  \addcontentsline{apc}{appendices}{Lampiran \thelampiran. #1}%
}
...
\globaldefs\@ne \let\c@loldepth\@neper
...
% --- AWAL BAGIAN LAMPIRAN ---
% \renewcommand{\thelampiran}{\Alph{lampiran}}

% % Definisi baru untuk \lampiran yang mereset semua counter
% \newcommand{\lampiran}[1]{%
%   \clearpage
%   \refstepcounter{lampiran}
%   \setcounter{figure}{0}
...
%   \phantomsection % Membuat hyperlink yang benar untuk TOC
