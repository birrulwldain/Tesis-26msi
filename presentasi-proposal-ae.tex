...
% ==========================================
\section{Latar Belakang, Rumusan Masalah dan Tujuan Penelitian}
...
\begin{frame}{Temuan Terdahulu: MultiElemental Radiative equiLibrIum emissioN (MERLIN) (Favre et al., 2025)}
  \begin{columns}[c]
...
\begin{frame}{Temuan Terdahulu: LIBS supported by machine learning (CNN) (Favre et al., 2025)}
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \centering
...
\begin{frame}{Temuan Terdahulu: Remote LIBS based on transformer-CNN (Liu et al., 2026)}
  \begin{columns}[c]
...
\begin{frame}{CNN-Transformer : Konsep usulan penelitian ini}
  \begin{figure}[H]
    \centering
...
\section{Solusi, Usulan Model CNN-Transformer}


% Slide 11: Visualisasi Konsep Tokenisasi
\begin{frame}{Bagaimana Spektrum di representasikan?}
  \begin{figure}[H]
    \centering
...
\begin{frame}{Bagaimana Model Menguraikan Spektrum?}
  \begin{columns}[c]
    \begin{column}{0.54\textwidth}
      \begin{figure}[H]
        \centering
    ...
    \begin{column}{0.44\textwidth}
      ...
      \begin{tikzpicture}[
          ...
          \node[cnn_box] (cnn_enc) at (-2.2, 4.3) {\textbf{CNN}\\\textbf{(Tokenizer)}};
          ...
          \node[cnn_box] (cnn_dec) at (-2.2, 0.5) {\textbf{CNN}\\\textbf{(Tokenizer)}};
...
\begin{frame}{Diagram Alir Penelitian}
\vspace{-0.5em}
\begin{center}
...
\begin{frame}[fragile]{Tahap I: MERLIN vs Penelitian Ini}
  \begin{center}
...
\begin{frame}{Tahap II: Setup Eksperimen LIBS}
  \centering
...
\begin{frame}{Tahap II: Eksperimen pada sampel Tanah Vulkanik}
  \centering
...
\begin{frame}{Tahap III: Pre-training Spektrum Sintetis}
  \centering
...
\begin{frame}{Tahap III: Alur Pelatihan \& GRL Adaptation Domain}
  \centering
  \begin{adjustbox}{max width=\textwidth, max height=0.82\textheight}
  \begin{tikzpicture}[
      font=\sffamily,
...
\begin{frame}{Tahap III: Alur Pelatihan Decoder Fine-Tuning}
  \centering
  \begin{adjustbox}{max width=\textwidth, max height=0.82\textheight}
  \begin{tikzpicture}[
      font=\sffamily,
...
% Slide 24: Rencana Pengujian: 5-Fold Cross Validation (Tahap 4)
\begin{frame}{Tahap IV: Bagaimana data Eksperimen dibagi?}
  \begin{figure}[H]
    \centering
...
% Slide 25: Rencana Pengujian: Skenario Transfer Domain
\begin{frame}{Tahap IV: Evaluasi Kinerja}
  \centering
  \begin{adjustbox}{max width=\textwidth, max height=0.82\textheight}
  \begin{tikzpicture}[
      font=\sffamily,
...
% Slide 26: Rencana Pengujian: Metode Evaluasi & Luaran (Tahap 4)
\begin{frame}{Tahap IV: Luaran Evaluasi Kinerja}
  \begin{center}
    \renewcommand{\arraystretch}{1.2}
...
\begin{frame}{Tempat \& Jadwal Penelitian}
  \begin{columns}[t]
    \begin{column}{0.45\textwidth}
      ...
      \fontsize{7.5pt}{9pt}\selectfont
      \begin{itemize}
        \item \textbf{Infrastruktur:} Kluster GPU dan CPU Mahameru HPC BRIN.
